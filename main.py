"""
CliniCore - Sistema Médico Completo
...
from app.core.exceptions import CliniCoreException, clini_core_exception_handler
...
async def lifespan(app: FastAPI):
    ...
    # Startup
    logger.info("Starting CliniCore Backend...")
    init_db()
...
# Exception handlers
app.add_exception_handler(CliniCoreException, clini_core_exception_handler)
